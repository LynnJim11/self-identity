...
- **📹 Demo Video**: [Download identity.mp4](./identity.mp4) - Watch the full demonstration of the encrypted one-time code verification system
- **🚀 Live Deployment**: [https://identityself.vercel.app/](https://identityself.vercel.app/) - Try the live application
